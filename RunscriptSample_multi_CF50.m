...
cdParams.metersperpixel = .02/760; %meters/pixel
cdParams.fsigma = 157.5;  %photoelastic stress coefficient
cdParams.g2cal = 2605.7822; %calibration Value for the g^2 method, can be computed by joG2cal.m (PEGS 1.0 version)
cdParams.dtol = 10; %how far away can the outlines of 2 particles be to still be considered Neighbors
cdParams.contactG2Threshold = 0.01; %sum of g2 in a contact area larger than this determines a valid contact
cdParams.CR = 10; %contact radius over which contact gradient is calculated
cdParams.imadjust_limits = [0,1]; %adjust contrast in green channel
...
dsParams.scaling = 0.2; %scale image by this much
