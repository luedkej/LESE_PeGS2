...
fsigma = 157.49; %C = 3327.13 %223;  %Photoelastic stress coefficient of this particle
rm = 0.0075; %0.01, 0.0075, 0.005 %Particle radius in meters
px = 1776; %2382, 1776  1138    %Return image size in pixels (of particle)
...
text(0.4,100,sprintf('%.3f * f + %0.3f',P(1),P(2)),'FontSize',16);

fprintf('Dein g2cal Wert ist: %.4f\n', P(1));