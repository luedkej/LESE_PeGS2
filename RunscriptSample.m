...
%% file parameters
fileParams.topDir       = 'C:\Users\Jakob\ETH\Reasearch_Assistance_LESE\repos\LESE_PeGS2\testdata\CF_50_2cm'; % where the top directory of the data will be stored
fileParams.imgDir       = 'images';     % where the images for force detection (green) are saved
fileParams.imgDirPos    = 'images_pos';  % where the images for position detection (red) are saved
...
dsParams.functionTolerance      = 0.0001; % if subsequent fits change by less than this amount, stop
